module.exports.config = {
  ...
  version: "1.0.0",
  credits: "Mirai-Team", // FIXED BY YAN Ebadat
...
let gifPath = __dirname + '/Nayan/join/download.mp4';

axios.get(gifUrl, { responseType: 'arraybuffer' })
.then(response => {
    fs.writeFileSync(gifPath, response.data);
    return api.sendMessage("চলে এসেছি আমি ভিলেই'ন ইবাদত❤️🔥 তোমাদের মাঝে🤭!", event.threadID, () => api.sendMessage({ body: `${global.config.BOTNAME} CONNECTED«\n\nAssalamualaykum☘️
<------------------------------>  
...
https://www.facebook.com/www.facebook.com/villainXebadat

🔵WHATSAPP NUMBER: wa.me/+97156815105

🟢SUPPORT EMAIL: thebranddunia@gmail.com`, attachment: fs.createReadStream(gifPath)}, threadID));
})
.catch(error => {
    console.error(error);
});
