...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("ইবাদত বস জাকে ভালোবাসতে চাউ তাকে @ম্যানশন করো😽🌸", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a("ইবাদত বস এর ভালোবাসা নাও😽🌸");
...
setTimeout(() => {a({body: " যেদিন তুমি সবকিছু বুঝতে পারবে - সেদিন আমি সিমান্ত থাকবো না! 🙂🌸 ভিলেই'ন ইবাদত🤝" + " " + name, mentions: arraytag})},23000);
